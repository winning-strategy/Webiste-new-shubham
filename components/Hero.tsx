...
const typingPhrases = [
  ...
  "Search and Compare from the Web",
    ...
    <section className="py-16 px-8 text-center max-w-6xl mx-auto">
      ...
      >
        ...
        <p className="text-xl text-gray-400 mb-8 max-w-3xl mx-auto">
          Transform your workflow with an AI agent that builds financial models, analyzes data, 
          and generates insights from natural language commands.
        </p>
