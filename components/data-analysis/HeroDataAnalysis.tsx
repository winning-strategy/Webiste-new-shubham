...
const typingPhrases = [
  "Write Code Through Prompts",
  "Work in Jupyter Interface",
  "Connect External APIs",
  "Generate Business Insights"
];

export default function HeroDataAnalysis() {
    ...
    <section className="py-16 px-8 text-center max-w-6xl mx-auto">
      ...
      >
        ...
        <p className="text-xl text-gray-400 mb-8 max-w-3xl mx-auto">
          Write executable code through prompts in a Jupyter notebook-like interface. 
          Perfect for business analysts who need insights without coding knowledge.
        </p>
