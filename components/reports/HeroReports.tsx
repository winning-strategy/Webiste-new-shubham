...
const typingPhrases = [
  ...
  "Build Market Analysis Reports",
  "Automate Status Summaries"
];

export default function HeroReports() {
    ...
    <section className="py-16 px-8 text-center max-w-6xl mx-auto">
      ...
      >
        ...
        <p className="text-xl text-gray-400 mb-8 max-w-3xl mx-auto">
          Transform your workflow with an AI agent that creates comprehensive reports, 
          executive summaries, and compliance documents from data and research.
        </p>
